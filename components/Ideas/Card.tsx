        ...
        <Card className={styles.card} variant="outlined" onClick={() => onClick()}>
            <Grid container columns={{ xs: 1 }} className={'m-0 pt-12 px-8 h-72'}>
                <Grid item xs={1} className={''}>
                    <Typography variant="h5" className={`${styles.title}`} color="#00F2FE">
                        {data.title}
                    </Typography>
                </Grid>
                <div className="mb-2">
                    <Grid item xs={1} className="flex flex-row gap-2 items-center">
                        <Image
                ...
                <Grid item xs={1} className="">
                    <div className={`${styles.cardDescription} whitespace-pre-wrap `}>
                        {data.description}
                    </div>
                </Grid>
